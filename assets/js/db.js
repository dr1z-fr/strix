...
(function () {
  ...
  const ERROR_MAP = {
    ...
    forbidden_unvalidate_cmd_only: 'Déverrouillage réservé au Commandement',
    forbidden_delete_validated_cmd_only: 'Suppression d\'une op verrouillée : Commandement uniquement',
    must_change_password: 'Vous devez d\'abord changer votre mot de passe',
